// Here, we test Gemmini's optimizations for conv layers with few input channels,
// like the first layer of most CNNs.
...
//#endif
    ...
    //bool success = vec_is_equal_fp32(&output[0][0][0][0], &output_mat[0][0], sizeof(output) / sizeof(elem_t));
#endif
